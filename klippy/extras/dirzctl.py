...
class DirZCtl:
    def __init__(self, config):
        ...
        self.mcu.register_serial_response(self._handle_debug_dirzctl, "debug_dirzctl oid=%c arg[0]=%u arg[1]=%u arg[2]=%u arg[3]=%u arg[4]=%u arg[5]=%u", self.oid)
        self.mcu.register_serial_response(self._handle_result_dirzctl, "result_dirzctl oid=%c step=%u tick=%u", self.oid)
