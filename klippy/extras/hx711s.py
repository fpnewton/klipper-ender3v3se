...
class HX711S:
    def __init__(self, config):
        ...
        self.mcu.register_serial_response(self._handle_debug_hx711s, "debug_hx711s oid=%c arg[0]=%u arg[1]=%u arg[2]=%u arg[3]=%u", self.oid)
        self.mcu.register_serial_response(self._handle_result_hx711s, "result_hx711s oid=%c vd=%c it=%c tr=%hu nt=%u v0=%i v1=%i v2=%i v3=%i", self.oid)
